...
--
-- Host: localhost
-- Generation Time: 2017-11-23 16:54:03
-- 服务器版本： 5.7.20-log
-- PHP Version: 5.6.32
...
(16, 'sh1_page_listnum1', '25', '后台列表项数量'),
...
(50, 'admin1', '20171123113318', '干得漂亮！', '成功在模块中创建了一条数据'),
(51, 'admin1', '20171123113605', '从坚固的长城上成功的取下一块砖', '成功删除一个模块'),
(52, 'admin1', '20171123113608', '从坚固的长城上成功的取下一块砖', '成功删除一个模块'),
(53, 'admin1', '20171123113614', '从坚固的长城上成功的取下一块砖', '成功删除一个控件'),
(54, 'admin1', '20171123113629', '手法很棒！', '成功在模块中删除一条数据'),
(55, 'admin1', '20171123113730', '手法很棒！', '成功在模块中删除一条数据'),
(56, 'admin1', '20171123113748', '从坚固的长城上成功的取下一块砖', '成功删除一个模块'),
(57, 'admin1', '20171123113755', '从坚固的长城上成功的取下一块砖', '成功删除一个控件'),
(58, 'admin1', '20171123113757', '从坚固的长城上成功的取下一块砖', '成功删除一个控件'),
(59, 'admin1', '20171123113800', '从坚固的长城上成功的取下一块砖', '成功删除一个控件'),
(60, 'admin1', '20171123113804', '从坚固的长城上成功的取下一块砖', '成功删除一个控件'),
(61, 'admin1', '20171123113806', '从坚固的长城上成功的取下一块砖', '成功删除一个控件'),
(62, 'admin1', '20171123113840', '干得漂亮！', '成功的编辑/创建了一个控件'),
(63, 'admin1', '20171123113906', '干得漂亮！', '成功的编辑/创建了一个控件'),
(64, 'admin1', '20171123113935', '干得漂亮！', '成功的编辑/创建了一个控件'),
(65, 'admin1', '20171123113957', '干得漂亮！', '成功的编辑/创建了一个模块'),
(66, 'admin1', '20171123114011', '干得漂亮！', '成功在模块中创建了一条数据'),
(67, 'admin1', '20171123114142', '手法不行！', '试图在模块中修改一条数据，但失败了'),
(68, 'admin1', '20171123114154', '手法不行！', '试图在模块中修改一条数据，但失败了'),
(69, 'admin1', '20171123114217', '手法不行！', '试图在模块中修改一条数据，但失败了'),
(70, 'admin1', '20171123114233', '手法很棒！', '成功在模块中删除一条数据'),
(71, 'admin1', '20171123114244', '干得漂亮！', '成功的编辑/创建了一个模块'),
(72, 'sheanjohn', '20171123114320', '风尘仆仆的来了', '成功登录系统'),
(73, 'sheanjohn', '20171123114321', '不幸被挡在门外', '试图进入没有权限的管理页面'),
(74, 'sheanjohn', '20171123114328', '头也不回的走了', '成功退出系统'),
(75, 'admin1', '20171123114334', '风尘仆仆的来了', '成功登录系统'),
(76, 'admin1', '20171123114342', '干得漂亮！', '成功在模块中创建了一条数据'),
(77, 'admin1', '20171123114342', '干得漂亮！', '成功在模块中创建了一条数据'),
(78, 'admin1', '20171123114343', '干得漂亮！', '成功在模块中创建了一条数据'),
(79, 'admin1', '20171123114351', '干得漂亮！', '成功在模块中修改了一条数据'),
(80, 'admin1', '20171123114351', '干得漂亮！', '成功在模块中修改了一条数据'),
(81, 'admin1', '20171123114351', '干得漂亮！', '成功在模块中修改了一条数据'),
(82, 'admin1', '20171123114431', '风尘仆仆的来了', '成功登录系统'),
(83, 'admin1', '20171123114505', '风尘仆仆的来了', '成功登录系统'),
(84, 'admin1', '20171123114513', '干得漂亮！', '成功在模块中创建了一条数据'),
(85, 'admin1', '20171123114513', '干得漂亮！', '成功在模块中创建了一条数据'),
(86, 'admin1', '20171123114513', '干得漂亮！', '成功在模块中创建了一条数据'),
(87, 'admin1', '20171123114520', '干得漂亮！', '成功在模块中修改了一条数据'),
(88, 'admin1', '20171123114520', '干得漂亮！', '成功在模块中修改了一条数据'),
(89, 'admin1', '20171123114520', '干得漂亮！', '成功在模块中修改了一条数据'),
(90, 'admin1', '20171123114559', '风尘仆仆的来了', '成功登录系统'),
(91, 'admin1', '20171123115113', '风尘仆仆的来了', '成功登录系统'),
(92, 'admin1', '20171123030926', '风尘仆仆的来了', '成功登录系统'),
(93, 'admin1', '20171123030947', '手法欠妥', '在试图创建/编辑栏目的时候发生错误'),
(94, 'admin1', '20171123031013', '头也不回的走了', '成功退出系统'),
(95, 'admin1', '20171123031030', '风尘仆仆的来了', '成功登录系统'),
(96, 'admin1', '20171123031049', '头也不回的走了', '成功退出系统'),
(97, 'sheanjohn', '20171123041511', '风尘仆仆的来了', '成功登录系统'),
(98, 'sheanjohn', '20171123041518', '不幸被挡在门外', '试图进入没有权限的管理页面'),
(99, 'admin1', '20171123044620', '风尘仆仆的来了', '成功登录系统'),
(100, 'admin1', '20171123044641', '干得漂亮！', '成功的编辑/创建了一条参数'),
(101, 'admin1', '20171123045323', '风尘仆仆的来了', '成功登录系统');
...
(7, '标题', '', 0, 20, '=', 0, 'str', '标题', 0),
(8, '详细内容', '', 0, 200, '<', 0, 'str', '编辑器', 3),
(9, '是否显示', '', 0, 10, '<', 0, 'str', '是否', 2);
...
(11, 4, 9, '是', '20171123114338', 1),
(12, 4, 7, 'adf 344', '20171123114338', 0),
(13, 4, 8, '<p>asdf222</p>', '20171123114338', 2),
(14, 4, 7, 'aaa24', '2017112311458', 0),
(15, 4, 9, '是', '2017112311458', 1),
(16, 4, 8, '<p>2344</p>', '2017112311458', 2);
...
--
ALTER TABLE `logmgr`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '日志id', AUTO_INCREMENT=102;
