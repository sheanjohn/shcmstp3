		...
		<div class="container">
			...
			<div class="nav-collapse">
				...
				$("#btn_logout").click(function(e) {
					...
					if(res){
						window.location.href="/admin.php/Home/Users/logout"
					}
           		});
			</script></li>
				</ul>
        ...
        if($(this).attr("name")==CONTROLLER_NAME){
			...
			<div class="span9">
				...
				<div class="well blank-slate" id="gbodx">
					<p>请从这里开始搜索：</p>
					<input type="text" placeholder="请输入用户名进行搜索..." id="ipt_search" />
					<button class="btn btn-sm btn-info" id="btn_search" style="margin-bottom:10px;"><i class="fa fa-search"></i> 查找用户</button>
					<button class="btn btn-sm btn-default" id="btn_all" style="margin-bottom:10px;"><i class="fa fa-undo"></i> 返回全部会员</button>
					<script>
				...
				<div class="span9" id="div_addnew" style="display: none;">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="input-xlarge" id="uname" disabled="disabled" />
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="input-xlarge"  id="shengri" placeholder="点击选择..."  onkeyup="this.value=''"/>
								<script>
									function getdtpk(){
						...
						<div class="control-group">
							...
							<div class="controls">
								<select id="utype">
									<?php if(is_array($sh1_user_type)): $i = 0; $__LIST__ = $sh1_user_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e1): $mod = ($i % 2 );++$i;?><option value="<?php echo ($e1); ?>"><?php echo ($e1); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select id="uleve">
									<?php if(is_array($sh1_user_level)): $i = 0; $__LIST__ = $sh1_user_level;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e2): $mod = ($i % 2 );++$i;?><option value="<?php echo ($e2); ?>"><?php echo ($e2); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
