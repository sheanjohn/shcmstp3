		...
		<div class="container">
			...
			<div class="nav-collapse">
				...
				$("#btn_logout").click(function(e) {
					...
					if(res){
						window.location.href="/admin.php/Home/Index/logout"
					}
           		});
			</script></li>
				</ul>
        ...
        if($(this).attr("name")==CONTROLLER_NAME){
			...
			<div class="span9">
				<div class="hero-unit">
					...
					<p>将来的你一定会感谢现在奋斗的你！</p>
					<p>
						<a href="<?php echo C('ROOT_DIR');?>/home/comm" href="help.htm"
							class="btn btn-primary"><i class="fa fa-cube"></i> 商品</a> <a
							href="<?php echo C('ROOT_DIR');?>/home/article" class="btn btn-info "><i
							class="fa fa-file"></i> 文章</a> <a href="<?php echo C('ROOT_DIR');?>/home/users"
							class="btn  btn-danger"><i class="fa fa-users"></i> 会员</a> <a
							href="<?php echo C('ROOT_DIR');?>/home/pic" class="btn  btn-success"><i
							class="fa fa-file-image-o"></i> 图库</a>
					</p>
				</div>
				<div class="well summary">
					<ul>
						<li><span class="count" style="margin-bottom: 10px;">
								<i class="fa fa-users"></i> <?php echo ($users); ?>
						</span>注册会员数</li>
						<li><span class="count" style="margin-bottom: 10px;">
								<i class="fa fa-list"></i> <?php echo ($dingdan); ?>
						</span>订单数</li>
						<li><span class="count" style="margin-bottom: 10px;">
								<i class="fa fa-cart-plus"></i> <?php echo ($active); ?>
						</span>活动数</li>
						<li class="last"><span class="count"
							style="margin-bottom: 10px;"> <i class="fa fa-cubes"></i>
								<?php echo ($comm); ?>
						</span>商品数</li>
					</ul>
				</div>
				<h2>
					<i class="fa fa-list-ol"></i> 最新订单预览
				</h2>
				...
				<ul class="pager">
					<li class="next"><a href="activity.htm">更多 &rarr;</a></li>
				</ul>
				<ul class="pager"
